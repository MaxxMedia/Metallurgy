...
const TAB_COPY: Record<AdminTab, { title: string; description: string }> = {
  ...
  articles: {
    ...
    description: "Publish articles, manage authors, and organize categories.",
  },
  companies: {
    title: "Companies",
...
export function AdminDashboardView() {
  ...
  useEffect(() => {
    if (tab !== "overview" && tab !== "articles") void loadTab(tab);
  }, [tab, loadTab]);
  ...
  return (
    ...
    >
      ...
      {tab === "articles" && token ? <ArticlesTab token={token} /> : null}
